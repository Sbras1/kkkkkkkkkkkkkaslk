...
bot.on("message", async (msg) => {
  ...
  if (text === "💳 الاشتراك") {
      ...
      await bot.sendMessage(chatId, 
          ...
          "تمتع بسرعة خيالية وخدمات حصرية لتجار الشدات المحترفين.\n" +
          "💰 **السعر:** 45 ريال / شهر\n\n" +
          "👇 **اضغط على الأزرار أدناه لتكتشف مميزات البوت:**", 
          { parse_mode: "Markdown", ...demoInlineKeyboard }
      );
      return;
  }
...
bot.on("callback_query", async (query) => {
  ...
  if (data === "demo_player") {
      await bot.sendMessage(chatId, 
          ...
          "فقط أرسل الآيدي (مثال: `512345678`) وسيحضر لك:\n" +
          "• اسم اللاعب.\n" +
          "• الآيدي (منسوخ).\n\n" +
